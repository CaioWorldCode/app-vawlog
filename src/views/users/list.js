...
const Component = () => {
    ...
    const loadData = async (pageLimit, page) => {
        ...
        try {
            let url = `/api/v1/private/user/list?order=${orderBy}&limit=${pageLimit}&page=${page}&search=${searchField}&organization_id=${currentUser.data.organization_id}`
                ...
                <Modal.Body>
                    ...
                    <Row className="g-2 mb-2">
                        <Col sm="12" xxl="12">
                            <Card >
                                <Card.Body className="text-center d-flex flex-column justify-content-center align-items-center">
                                    <CsLineIcons icon="user" className="text-primary" size={50} />
                                    <p className="heading mb-0">
                                        Novo usuário
                                    </p>

                                    <p className="text-medium mb-0">
                                        Como administrador, você pode criar uma conta para um novo usuário preenchendo o formulário abaixo com as informações pessoais do usuário. Certifique-se de fornecer um endereço de e-mail válido para que o novo usuário possa receber instruções para acessar sua conta. <br /><br /> Depois de concluir o cadastro, o usuário terá acesso aos serviços exclusivos oferecidos por nós. Se o usuário já possuir uma conta conosco, você pode orientá-lo a fazer login com as credenciais existentes.
                    ...
                    <Formik
                        initialValues={{
                            ...
                            status: '',
                            role: 'Client',
                            organization_id: currentUser?.data?.organization_id
                        }}
                ...
                <Modal.Body>
                    ...
                    <Row className="g-2 ">
                        <Col sm="12" xxl="12">
                            <Card >
                                <Card.Body className="text-center d-flex flex-column justify-content-center align-items-center">
                                    <CsLineIcons icon="edit" className="text-primary" size={50} />
                                    <p className="heading mb-0">
                                        Editar dados do usuário
                                    </p>

                                    <p className="text-medium mb-0">
                                        Ao editar seus dados pessoais, é importante garantir que as informações fornecidas sejam precisas e atualizadas. 
                                        Certifique-se de verificar todas as informações antes de salvar as alterações. <br /><br />

                                        Ao editar informações sensíveis, como endereço de e-mail verifique se você está em um ambiente seguro e privado. <br />
                                        Nunca compartilhe suas informações pessoais com terceiros não confiáveis e tenha cuidado ao inserir informações em sites desconhecidos ou suspeitos.                                    </p>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
                ...
                <Modal.Body>
                    ...
                    <Row className="g-2 ">
                        <Col sm="12" xxl="12">
                            <Card >
                                <Card.Body className="text-center d-flex flex-column justify-content-center align-items-center">
                                    <CsLineIcons icon="shield" className="text-warning" size={50} />
                                    <p className="heading mb-0">
                                        Alteração de senha
                                    </p>
                                    ...
                                    <p className="text-medium mb-0">
                                        ...
                                        Para garantir a segurança da conta, é altamente recomendável que você crie senhas fortes e as altere regularmente. <br />
                                        Ao criar uma nova senha, lembre-se de escolher uma combinação de letras, números e caracteres especiais, e evite usar informações pessoais facilmente identificáveis, como nomes, datas de nascimento ou números de telefone.<br />
                                        Além disso, nunca compartilhe sua senha com ninguém e evite reutilizar senhas antigas. <br /> <br />
                                    </p>
                                </Card.Body>
                            </Card>
                        </Col>
